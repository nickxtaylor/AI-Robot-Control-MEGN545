...
title('MRC Output Error vs. Time')
xlabel('time')
ylabel('U - Y')
...
%
time_tr = (0 : tr_dat16.Ts : tr_dat16.Ts * length(tr_dat16.U) - tr_dat16.Ts)';
err_tr = tr_dat1.U - tr_dat1.Y;
...
plot(time_tr, tr_dat16.U, 'LineWidth', 1.25)
plot(time_tr, tr_dat16.Y, 'LineWidth', 1.25)
